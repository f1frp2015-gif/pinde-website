...
export const landingContent = {
  en: {
    ...
    rfq: {
      ...
      error:
        "The RFQ could not be sent. Please try again or email the files directly to inqury@pindesys.com.",
  ...
  ru: {
    ...
    rfq: {
      ...
      error:
        "Не удалось отправить запрос. Повторите попытку или отправьте файлы напрямую на inqury@pindesys.com.",
