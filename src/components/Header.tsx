        ...
        <div className={`border-b transition-shadow ${scrolled ? "border-[#C9D6DE] shadow-[0_8px_24px_rgba(16,47,69,0.08)]" : "border-[#D8E1E6]"}`}>
          <div className="mx-auto flex h-16 max-w-[1280px] items-center justify-between px-5 sm:px-8 lg:h-[72px] lg:px-10">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href={`/${locale}/contact`} className="hidden min-h-11 items-center bg-[#D62832] px-5 text-[11px] font-bold text-white transition-colors hover:bg-[#B91F28] sm:inline-flex">
                {content.headerCta}
              </Link>
              <button
                type="button"
        ...
        {mobileOpen && (
          <div className="border-b border-[#C9D6DE] bg-white shadow-[0_18px_40px_rgba(16,47,69,0.12)] lg:hidden">
            <nav className="mx-auto max-w-[1280px] px-5 py-4 sm:px-8">
              ...
              <Link href={`/${locale}/contact`} onClick={() => setMobileOpen(false)} className="mt-4 flex min-h-12 items-center justify-center bg-[#D62832] px-5 text-[12px] font-bold text-white">
                {content.headerCta}
              </Link>
            </nav>
          </div>
