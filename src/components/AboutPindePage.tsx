    ...
    <article lang={content.lang} className="market-shell overflow-hidden bg-white text-[#142C3D]">
        ...
        <div className={`${container} grid lg:grid-cols-[1.02fr_0.98fr]`}>
          <div className="flex flex-col justify-center py-14 lg:min-h-[650px] lg:py-20 lg:pr-16">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link href={`/${locale}/contact`} className="inline-flex min-h-12 items-center justify-center gap-3 bg-[#D62832] px-6 py-3 text-[12px] font-bold text-white transition-colors hover:bg-[#B91F28]">
                {content.hero.primaryCta}
                <ArrowRight size={16} />
              </Link>
              <Link href={`/${locale}/supply`} className="inline-flex min-h-12 items-center justify-center gap-3 border border-[#0E527D] px-6 py-3 text-[12px] font-bold text-[#0E527D] transition-colors hover:bg-white/65">
      ...
      <section className="py-16 lg:py-24">
        ...
        <div className={`${container} mt-12`}>
          ...
          <p className="mt-3 text-center text-[11px] font-semibold uppercase tracking-[0.06em] text-[#647986]">
            {locale === "ru"
          ...
          <div className="mt-10 grid gap-[13px] md:grid-cols-2">
            <div className="relative aspect-[3/2] overflow-hidden border border-[#C9D6DE]">
              <Image
                ...
                className="object-cover"
              />
              <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-[#102F45]/85 to-transparent p-4 pt-10">
      ...
      {/* ── CTA ── */}
      <section className="mt-16 bg-[#D62832] py-14 text-white lg:py-16 lg:mt-24">
        <div className={`${container} grid items-end gap-8 lg:grid-cols-[1fr_auto]`}>
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
            <Link href={`/${locale}/contact`} className="inline-flex min-h-12 items-center justify-center gap-3 bg-white px-6 py-3 text-[12px] font-bold text-[#B91F28] transition-colors hover:bg-[#FFF1F1]">
              {content.cta.primary}
              <ArrowRight size={16} />
            </Link>
